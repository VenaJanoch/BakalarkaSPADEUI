...
public class CommitValueCopyTest {
    ...
    public void setUp() throws Exception {
        ...
        dataModel.getEditDataModel().editDataInCommit("Test", name, indicators, name, indicators, dates, indicators, true, 3, 1, false, 2);
        dataModel.getSaveDataModel().createNewCommit(3);
        dataModel.getDataManipulator().copyDataFromCommit(2, 3, 43, 45);
        commit = dataModel.getCommit(3);

    }

    @Test
    public void testAlias() {
        assertEquals("3", commit.getAlias());
    }
    ...
    public void testCoords() {
        assertSame(43, commit.getCoordinates().getXCoordinate());
        assertSame(45, commit.getCoordinates().getYCoordinate());
    }
