...
public class StatusDeleteTest {
        ...
        public void setUp() throws Exception {
            ...
            formDataController.saveDataFromStatusForm("Jmeno1", new ClassTable("0_Jmeno1","Test", "Test",0));
            formDataController.saveDataFromStatusForm("Jmeno1", new ClassTable("0_Jmeno1","Test", "Test",1));
            ...
            deleteFormController.deleteStatus(observableList, basicTables);
    ...
    public void testExist() {
        assertSame(1, project.getStatus().size());
    }
    ...
    public void testRemoveFromMilestone() {
        assertSame(-1, workUnit.getStatusIndex());
    }
