...
public class SeverityDeleteTest {
    ...
    public void testDeleteCorectItem() {
        assertSame(1, dataModel.getSeverities().get(0).getId());
    }
    ...
    @Test
    public void testWU() {
        assertSame(1, workUnit.getSeverityIndex().size());
        int index = workUnit.getSeverityIndex().get(0);
        assertSame(1, dataModel.getSeverityId(index));
    }
}